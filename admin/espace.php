    ...
    if ($act == "addProd") {
        ...
        <form method="POST" action="">
            <table cellspacing="15" cellpadding="5" border="1" align="center">
                <tr>
                    <td>
                        <input type="number" name="codeProd" placeholder="Le code de produit" required>
                    </td>
                </tr>
                <tr>
                    <td>
                        <input type="text" name="nomProd" placeholder="Le nom de produit" required>

                    </td>
                </tr>
                <tr>
                    <td>
                        <input type="number" name="quantite" placeholder="La quantité" required>

                    </td>
                </tr>
                <tr>
                    <td>
                        <input type="date" name="datFab" placeholder="La de fabrication" style="width: 170px;" required>

                    </td>
                </tr>
                <tr>
                    <td>
                        <input type="date" name="datExp" placeholder="La date d'expiration" style="width: 170px;" required>

                    </td>
                </tr>
                <tr>
                    <td>
                        <input type="text" name="nom" placeholder="Le nom de votre produit" required>
                ...
                <tr>
                    <td>
                        <input type="number" name="prix" placeholder="Le prix" required>
